...
import {validateEmail, validatePassword, ErrorState} from "../src/utils/formUtils";
...
const validate = (email: string, password: string, firstName: string, lastName: string): ErrorState<"email" | "password" | "firstName" | "lastName"> => {
  const errors = {
...
const httpTrigger: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    const errors = validate(req.body.email, req.body.password, req.body.firstName, req.body.lastName);
    let errorMessage = "";
