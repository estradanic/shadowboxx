enum QueryCacheGroups {
  ...
  GET_IMAGES_BY_OWNER = "GET_IMAGES_BY_OWNER",
  ...
  GET_IMAGE_BY_OWNER_INFINITE = "GET_IMAGE_BY_OWNER_INFINITE",
  GET_USERS_BY_EMAIL_INFINITE = "GET_USERS_BY_EMAIL_INFINITE",
  GET_RELATED_USER_EMAILS_INFINITE = "GET_RELATED_USER_EMAILS_INFINITE",
}
